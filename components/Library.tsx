...
export const Library: React.FC = () => {
  ...
  const TabButton = ({ cat, label }: { cat: FilterCategory, label: string }) => (
    <button
      ...
      className={`px-3 py-1 md:px-4 md:py-2 rounded-lg text-xs md:text-sm font-serif transition-all border ${
        filter === cat 
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <h2 className="text-3xl font-serif text-amber-400 text-center mb-6">Grimório do Tarot</h2>
